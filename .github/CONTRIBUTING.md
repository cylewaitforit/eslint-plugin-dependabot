...
Please do [report an issue on the issue tracker](https://github.com/cylewaitforit/eslint-plugin-dependabot/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository! Please fully fill out all required fields in the most appropriate issue form.
